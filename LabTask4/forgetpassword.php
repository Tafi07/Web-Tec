...
$CurrentPasswordErr = $NewPasswordErr =  $RetypePasswordErr =   $EmailErr = "" ;
$CurrentPassword = $NewPassword =  $RetypePassword = $Email = "" ;
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  Enter E-mail: <input type="text" name="Email" value="<?php echo $Email;?>">
  <span class="error">* <?php echo $RetypePasswordErr;?></span>
  <br><br>
